...
{
    /// <inheritdoc />
    public partial class AddBookStyleBaseline : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BookStyleBaselines",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookStyleBaselines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookStyleBaselines_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookStyleBaselines_BookId_Language",
                table: "BookStyleBaselines",
